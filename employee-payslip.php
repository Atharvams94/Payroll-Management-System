...
<!-- Top menu on small screens -->
      ...
      <form class="page-container" action="employee-payslipshow.php" method="post">
          
                
                 <p>
                     <label class="danger">Select Year</label>
                      <input class="page-input page-light-grey page-animate-input" type="number" name="year" required></p><br>
                <p> <label class="danger">Select Month</label>
